...
1. Create ansible playbooks to create **[deployment](https://github.com/rob1kenobi/Simple-DevOps-Project/blob/master/Kubernetes/kubernetes-valaxy-deployment.yml)** and **[services](https://github.com/rob1kenobi/Simple-DevOps-Project/blob/master/Kubernetes/kubernetes-valaxy-service.yml)** 
